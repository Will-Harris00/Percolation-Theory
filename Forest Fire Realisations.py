...
def main():
    ...
    for n in sizes:
        ...
        plt.show()
    with pd.ExcelWriter("forestpcnrep.xlsx") as writer:
        writer.save()
        print("Created the excel file 'forestpcnrep.xlsx'")
    try:
        with pd.ExcelWriter("forestpcnrep.xlsx", engine='openpyxl', mode='a') as writer:
            writer.book = load_workbook("forestpcnrep.xlsx")
        ...
        print("Please ensure the file 'forestpcnrep.xlsx' is not open in another program")
