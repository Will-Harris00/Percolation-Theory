...
def main():
    ...
    plt.show()
    with pd.ExcelWriter("forestpcsize.xlsx") as writer:
        writer.save()
        print("Created the excel file 'forestpcsize.xlsx'")
    try:
        with pd.ExcelWriter("forestpcsize.xlsx", engine='openpyxl', mode='a') as writer:
            writer.book = load_workbook("forestpcsize.xlsx")
        ...
        print("Please ensure the file 'forestpc.xlsx' is not open in another program")
